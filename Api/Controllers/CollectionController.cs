...
namespace Api.Controllers
{
    ...
    public class CollectionController : ControllerBase
    {
        ...
        public CollectionController(IUserService _userService, ICollectionService _collectionService, ICollectionSortService _sortService, IQuizService _quizService)
        {;
        ...
        public async Task<IActionResult> QuizGame(int id, CancellationToken cancellationToken)
        {
            ...
            var quizCard = await quizService.CreateTask(id, currentUser, cancellationToken);
