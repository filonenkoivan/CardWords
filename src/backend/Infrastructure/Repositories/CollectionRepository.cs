...
namespace Infrastructure.Repositories
{
    public class CollectionRepository : ICollectionRepository
    {
        ...
        public async Task<CardCollection> GetCollection(int id, CancellationToken cancellationToken = default)
        {
            var collection = await _db.CardCollections.Include(x => x.CardList).FirstOrDefaultAsync(x => x.Id == id);
            return collection;
        }
